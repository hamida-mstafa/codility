...
def shorten_speech(speech):
    return re.sub(r'\b(\S{3,}?)[aeiou]\S*', r'\1.', speech)

# Example Usage
speech_input = "This is a sample speech that needs shortening."
shortened_speech = shorten_speech(speech_input)
print(shortened_speech)
